...
//INFO6044 Game Engine (Final)
//main.cpp description:
//				The purpose of the final is to apply everything we've done in the course and make Space Invaders
...
void CreateTheShips()
{
	...
	{ // Space Invaders
		...
		invader.vec_sData.push_back("I2");
