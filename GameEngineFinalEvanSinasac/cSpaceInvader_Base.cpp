...
cSpaceInvader_Base::cSpaceInvader_Base()
{
...
void cSpaceInvader_Base::Update(double deltaTime)
{
	if (exploding1)
	{
...
std::string cSpaceInvader_Base::getName(void)
{
	return this->myShipName;
}

cMesh* cSpaceInvader_Base::getMeshPointer(void)
{
...
bool cSpaceInvader_Base::SetReciever(iMediator* pTheReciever)
{
...
bool cSpaceInvader_Base::RecieveMessage(sMessage theMessage)
{
		...
		for (unsigned int y = 0; y < Y; y++)
		{
			for (unsigned int x = 0; x < X; x++)
			{
				...
				if (this->blockPose1[x][y] == "X")
				{
					...
					pSolid->wholeObjectDiffuseRGBA = glm::vec4((204.0f / 255.0f), 1.0f, 1.0f, 1.0f);
...
bool cSpaceInvader_Base::RecieveMessage(sMessage theMessage, sMessage& messageReply)
{
	return true;
}

/*static*/ const std::string cSpaceInvader_Base::SPACE_INVADER_SHIPTYPE_AS_STRING = "Base";

std::string cSpaceInvader_Base::getShipTypeAsString(void)
{
	return cSpaceInvader_Base::SPACE_INVADER_SHIPTYPE_AS_STRING;
}

unsigned int cSpaceInvader_Base::getShipTypeAsUInt(void)
{
	return cSpaceInvader_Base::SPACE_INVADER_SHIPTYPE_AS_UINT;
}

// *******************************************************************
// From the iPhysicalObject interface
glm::vec3 cSpaceInvader_Base::getPosition(void)
{
	return this->m_PhysicalProperties.position;
}

void cSpaceInvader_Base::setPosition(const glm::vec3& newPosition)
{
	this->m_PhysicalProperties.position = newPosition;
	return;
}

glm::vec3 cSpaceInvader_Base::getVelocity(void)
{
	return this->m_PhysicalProperties.velocity;
}

void cSpaceInvader_Base::setVelocity(const glm::vec3& newVelocity)
{
	this->m_PhysicalProperties.velocity = newVelocity;
	return;
}

glm::vec3 cSpaceInvader_Base::getAcceleration(void)
{
	return this->m_PhysicalProperties.acceleration;
}

void cSpaceInvader_Base::setAcceleration(const glm::vec3& newAcceleration)
{
	this->m_PhysicalProperties.acceleration = newAcceleration;
	return;
}

glm::vec3 cSpaceInvader_Base::getOrientationEuler(void)
{
	return this->m_PhysicalProperties.orientationEuler;
}

void cSpaceInvader_Base::setOrientationEuler(const glm::vec3& newOrientationEuler)
{
	this->m_PhysicalProperties.orientationEuler = newOrientationEuler;
	return;
}

glm::quat cSpaceInvader_Base::getOrientationQuaternion(void)
{
	return this->m_PhysicalProperties.orientationQuat;
}

void cSpaceInvader_Base::setOrientationQuaternion(const glm::quat& newOrientationQuaternion)
{
	this->m_PhysicalProperties.orientationQuat = newOrientationQuaternion;
	return;
}

sPhysicalProps cSpaceInvader_Base::getPhysicalProperties(void)
{
	return this->m_PhysicalProperties;
}

void cSpaceInvader_Base::setPhysicalProperties(const sPhysicalProps& newPhysProps)
{
...
bool cSpaceInvader_Base::loadBlockPose1(std::string fileName)
{
	std::stringstream ss;
...
//bool cSpaceInvader_Base::loadBlockPose2(std::string fileName)
//{
//	std::stringstream ss;
//	//ss << SOLUTION_DIR << "\\GameEngineFinalEvanSinasac\\";
//	ss << fileName;
...
bool cSpaceInvader_Base::loadExplosion1(std::string fileName)
{
	std::stringstream ss;
	//ss << SOLUTION_DIR << "\\GameEngineFinalEvanSinasac\\";
	ss << fileName;
...
bool cSpaceInvader_Base::loadExplosion2(std::string fileName)
{
	std::stringstream ss;
	//ss << SOLUTION_DIR << "\\GameEngineFinalEvanSinasac\\";
	ss << fileName;
